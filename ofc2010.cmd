...
echo.
echo  OFFICE 2010 ACTIVATION 
echo  Dev By Izzar Suly Nashrudin
pause

title Activate Microsoft Office 2010 without Software - Avezoor
cls
color 0a
(net session >nul 2>&1)
if %errorLevel% GTR 0 (
...
echo =============================================================
echo [*] Activating Microsoft Office 2010 (No Software Needed)
echo =============================================================
echo.
echo [+] Supported Editions:
echo     - Microsoft Office Standard 2010 Volume
echo     - Microsoft Office Professional Plus 2010 Volume
echo.
echo [+] Preparing environment...

:: Navigate to Office14 folder
...
:: Install valid Office 2010 volume keys
